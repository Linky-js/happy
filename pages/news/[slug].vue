...
onMounted(() => {
  post.value = {
    thumb: '/img/post-img.jpg',
    title: 'Что мы узнали о счастье, путешествуя по России',
    date: '3 июля 2025',
    author: 'Наталья Воронина',
    tag: 'Философия',
    time: '~12 мин.',
    top_text: 'Мы часто ищем счастье за тридевять земель: в медитациях на Бали, в шопинге в Милане или на закатах над океаном. Мы привыкли думать, что счастье — это нечто экзотическое, яркое и обязательно дорогое. Но что, если его секреты спрятаны гораздо ближе? Мы отправились в путешествие по России не для того, чтобы просто посмотреть достопримечательности, а чтобы понять, что же делает счастливыми людей в самых разных ее уголках. И вот какие открытия мы привезли с собой.',
    blocks: [
      {
        content: `<h3>1. Счастье — в простоте и умении довольствоваться малым</h3>
        <p>На берегу Байкала, в маленькой деревне, мы встретили старого рыбака. Его дом был прост, а вещей — минимум. Сидя у костра, он сказал: «У меня есть озеро, небо над головой и уха в котелке. Чего еще надо?» Эта фраза стала для нас ключевой. Мы привыкли к бесконечному «хочу»: больше денег, больше вещей, больше впечатлений. А здесь мы увидели, что настоящее счастье рождается не от приумножения, а от умения ценить то, что уже есть. Чистый воздух, вкусный чай, тепло огня и тишина — вот настоящие богатства.</p>
        `,
        imgs: [
          '/img/news-1.jpg',
          '/img/news-2.jpg',
      ...
      {
        content: `<h3>2. Оно в гостеприимстве и общении</h3>
        <p>На Кавказе нас поразила не столько природа, сколько люди. Здесь действует негласный закон: гость — это благословение. Нас приглашали в дома, угощали, даже не зная наших имен. За одним большим столом могли собраться совершенно разные люди, но за разговором, песнями и тостами исчезали все барьеры. Мы поняли: счастье множится, когда ты делишься им. Оно живет в моментах искреннего человеческого общения, в чувстве, что ты не один, что тебе рады просто так, без всяких условий.</p>
        `,
        img: '/img/news-1.jpg'
      },
      {
        content: `<h3>3. Счастье — это чувство принадлежности к чему-то великому</h3>
        <p>Стоя на Красной площади в Москве или глядя на развод мостов в Санкт-Петербурге, ты ощущаешь дыхание истории. Но то же самое мы чувствовали и в древнем Великом Новгороде, и у стен крепости в Derbent. Это не гордость за империю, а глубинное чувство связи с предками, с культурой, с огромной страной, у которой такая сложная и великая судьба. Осознание себя частью этой огромной истории, этой силы природы и духа — дает опору. А счастье, как известно, начинается с чувства безопасности и принадлежности.</p>
        `,
        imgs: [
          '/img/poster-1.jpg',
          '/img/poster-2.jpg',
      ...
      {
        content: `<h3>4. Оно в контрастах и умении их принимать</h3>
        <p>Россия — страна контрастов. За одну поездку можно увидеть и блеск золотых куполов, и суровую простоту деревенской избы; испытать и летнюю жару в Калмыкии, и пронизывающий ветер на Кольском полуострове. Сначала это сбивает с толку, но потом приходит осознание: жизнь многогранна. Счастье — это не постоянный праздник. Это и радость, и грусть, и труд, и отдых. Русская душа, кажется, интуитивно это понимает и умеет находить свет даже в самые темные времена, что рождает ту самую, знаменитую на весь мир, «загадочную русскую душу» — стойкую и способную на глубокие чувства.</p>
        `,
      },
      {
        content: `<h3>5. Счастье в силе и стойкости</h3>
        <p>Путешествие по Уралу или Сибири невольно заставляет задуматься о силе человеческого духа. Суровые условия воспитывают стойкость. Местные жители не жалуются на жизнь, а просто делают свое дело. Эта «сибирская закалка» учит главному: счастье — это не отсутствие проблем, а уверенность в том, что ты сможешь с ними справиться. Оно в осознании собственной внутренней силы, которая вырастает именно тогда, когда приходится преодолевать трудности.</p>
        `,
      },
    ]
  }
...
<template>
  <section class="article" v-if="post">
    ...
    <div class="container">
      ...
      <div class="article__content">
        ...
        <div class="article__block" v-for="(block, i) in post.blocks" :key="i">
          <div class="article__block-text" v-html="block.content"></div>
          <div class="article__block-imgs" v-if="block.imgs">
            <div class="arrows">
            ...
            <Swiper class="article__block-swiper" :slides-per-view="'auto'" :space-between="20" :modules="[Navigation]"
              ...
              >
              <SwiperSlide v-for="(img, j) in block.imgs" :key="j">
                <img :src="img" alt="">
              </SwiperSlide>
            </Swiper>
  ...
  <NewsBlock title="Другие статьи" class="news-another" />
